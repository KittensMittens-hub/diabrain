...
ggplot() +
  ...
  labs(title = "График динамики уровня нейронспецифической енолазы \nпо визитам и группам терапии",
       caption = "Среднее значение ± SEM",
       x = "Месяц",
       y = "NSE, нг/мл") +
  theme(plot.caption = element_text(size = 20, hjust = 1),
...
```{r, fig.width=15, fig.height=8}
Lchains_long_treatment <- data_long %>% 
  filter(time %in% c("0", "3", "6", "12")) %>% 
  group_by(Treatment, time) %>% 
  summarise(mean_score = mean(Lchains, na.rm = TRUE),
            sem_score = sd(Lchains, na.rm = TRUE) / sqrt(sum(!is.na(Lchains))), 
...
ggplot() +
  geom_line(data = data_long %>% filter(time %in% c("0", "3", "6", "12")),
       aes(x = time, y = Lchains, group = ID, color = Treatment),
       alpha = 0.4, size = 0.5) +
  geom_line(data = Lchains_long_treatment, 
            aes(x = time, y = mean_score, group = Treatment, color = Treatment), 
            size = 1) +
  geom_ribbon(data = Lchains_long_treatment,
              aes(x = time, group = Treatment, fill = Treatment,
                  ymin = mean_score - sem_score,
                  ymax = mean_score + sem_score),
              alpha = 0.3)+
  ...
  scale_fill_brewer(palette = "Set2", name = "Терапия")+
  scale_color_brewer(palette = "Set2", name = "Терапия")+
  labs(title = "График динамики уровня легких цепей нейрофиламента\nпо визитам и группам терапии",
       caption = "Среднее значение ± SEM",
       x = "Месяц",
       y = "Lchains, нг/мл") +
  theme(plot.caption = element_text(size = 20, hjust = 1),
...
ggplot() +
  ...
  scale_fill_brewer(palette = "Set2", name = "Терапия")+
  scale_color_brewer(palette = "Set2", name = "Терапия")+
  labs(title = "График динамики уровня гликированного гемоглобина\nпо визитам и группам терапии",
       caption = "Среднее значение ± SEM",
       x = "Месяц",
       y = "HbA1c, %") +
  theme(plot.caption = element_text(size = 20, hjust = 1),
...
ggplot() +
  ...
  scale_fill_brewer(palette = "Set2", name = "Терапия")+
  scale_color_brewer(palette = "Set2", name = "Терапия")+
  labs(title = "Динамика распределения баллов Монреальской шкалы\nпо визитам и группам терапии",
       caption = "Среднее значение ± SEM",
       x = "Месяц",
       y = "MOCA, балл") +
  theme(plot.caption = element_text(size = 20, hjust = 1),
...
ggplot() +
  ...
  scale_fill_brewer(palette = "Set2", name = "Терапия")+
  scale_color_brewer(palette = "Set2", name = "Терапия")+
  labs(title = "Динамика распределения баллов краткой шкалы оценки психического статуса\nпо визитам и в группах терапии",
       caption = "Среднее значение ± SEM",
       x = "Месяц",
       y = "MMSE, балл") +
  theme(plot.caption = element_text(size = 20, hjust = 1),
