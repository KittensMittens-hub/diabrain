...
```{r}
ggplot(merged_data, aes(x = Treatment.x, fill = Sex)) +
...
```{r}
ggplot(merged_data, aes(y = `DM duration`, x = Treatment.x, fill = Treatment.x)) +
...
```{r}
ggplot(merged_data, aes(y = `Age`, x = Treatment.x, fill = Treatment.x)) +
  geom_boxplot(width = 0.5, alpha = 0.8, color = "gray40", 
               outlier.color = "gray30", outlier.shape = 16) +
  scale_fill_brewer(palette = "Set2") + 
  labs(
...
HbA1c_long <- merged_data %>%
  select(`HbA1c 0`, `HbA1c 3`, `HbA1c 6`, `HbA1c 9`, `HbA1c 12`) %>% 
...
```{r}
HHbA1c_long <- merged_data %>%
  select(Treatment.x, `HbA1c 0`, `HbA1c 3`, `HbA1c 6`, `HbA1c 9`, `HbA1c 12`) %>% 
  pivot_longer(cols = c(`HbA1c 0`, `HbA1c 3`, `HbA1c 6`, `HbA1c 9`, `HbA1c 12`),
               names_to = "month",
               values_to = "HbA1c") %>%
  mutate(month = gsub("HbA1c ", "", month),
...
```{r}
ggplot(HHbA1c_long, aes(x = month, y = HbA1c, fill = Treatment.x)) +
...
```{r}
HbA1c_summary <- HHbA1c_long %>%
  group_by(Treatment.x, month) %>%
  summarise(
...
ggplot(HbA1c_summary, aes(x = month, y = mean_HbA1c, 
                           group = Treatment.x, color = Treatment.x)) +
  geom_line(size = 1) +
  geom_point(size = 3) +
...
NSE_long <- merged_data %>%
  select(Treatment.x,`NSE 0`, `NSE 3`, `NSE 6`, `NSE 12`) %>% 
...
```{r}
ggplot(NSE_long, aes(x = month, y = NSE, fill = Treatment.x)) +
  geom_boxplot(position = position_dodge(width = 0.8), 
               alpha = 0.8, color = "gray30") +
  scale_fill_brewer(palette = "Set2", name = "Терапия") +
  labs(
...
Lchains_long <- merged_data %>%
  select(Treatment.x,`Lchains 0`, `Lchains 3`, `Lchains 6`, `Lchains 12`) %>% 
...
```{r}
ggplot(Lchains_long, aes(x = month, y = Lchains, fill = Treatment.x)) +
  geom_boxplot(position = position_dodge(width = 0.8), 
               alpha = 0.8, color = "gray30") +
  scale_fill_brewer(palette = "Set2", name = "Терапия") +
  labs(
...
S100_long <- merged_data %>%
  select(Treatment.x,`S100 0`, `S100 3`, `S100 6`, `S100 12`) %>% 
...
```
```{r}
ggplot(S100_long, aes(x = month, y = S100, fill = Treatment.x)) +
  geom_boxplot(position = position_dodge(width = 0.8), 
               alpha = 0.8, color = "gray30") +
  scale_fill_brewer(palette = "Set2", name = "Терапия") +
  labs(
...
BMI_long <- merged_data %>%
  select(Treatment.x, `BMI 0`, `BMI 3`, `BMI 6`, `BMI 9`, `BMI 12`) %>% 
...
ggplot(BMI_long, aes(x = month, y = BMI, fill = Treatment.x)) +
  geom_boxplot(position = position_dodge(width = 0.8), 
               alpha = 0.8, color = "gray30") +
  scale_fill_brewer(palette = "Set2", name = "Терапия") +
  labs(
...
MOCA_long <- merged_data %>%
  select(Treatment.x, `MOCA 0`, `MOCA 3`, `MOCA 6`, `MOCA 9`, `MOCA 12`) %>% 
...
ggplot(MOCA_long, aes(x = month, y = MOCA, fill = Treatment.x)) +
  geom_boxplot(position = position_dodge(width = 0.8), 
               alpha = 0.8, color = "gray30") +
  scale_fill_brewer(palette = "Set2", name = "Терапия") +
  labs(
